...
function init_gear_sets()
    ...
    sets.TreasureHunter = {  hands={ name="Plun. Armlets +1", augments={'Enhances "Perfect Dodge" effect',}}, legs={ name="Herculean Trousers", augments={'STR+2','Weapon skill damage +2%','"Treasure Hunter"+2','Mag. Acc.+5 "Mag.Atk.Bns."+5',}}, feet="Skulk. Poulaines +1", }
    sets.TreasureHunterRA = {  hands={ name="Plun. Armlets +1", augments={'Enhances "Perfect Dodge" effect',}}, legs={ name="Herculean Trousers", augments={'STR+2','Weapon skill damage +2%','"Treasure Hunter"+2','Mag. Acc.+5 "Mag.Atk.Bns."+5',}}, feet="Skulk. Poulaines +1", }
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {right_ear="Odr Earring"
    })
