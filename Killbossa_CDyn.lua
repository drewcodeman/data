...
function init_gear_sets()
	...
	-- Precast Sets
	 ...
	 HerculeanLegs = {}
     HerculeanLegs.WSD = {name="Herculean Trousers", augments={'"Snapshot"+2'}}
	 HerculeanLegs.MAB = {name="Herculean Trousers", augments={'Mag. Acc.+14 "Mag.Atk.Bns."+14','INT+2','"Mag.Atk.Bns."+14',}}
	...
	sets.precast.WS['Leaden Salute'] = set_combine(sets.precast.WS['Wildfire'], { head="Pixie Hairpin +1", ear2="Friomisi Earring", ear1="Moonshade Earring"})
	...
	sets.idle.Town = {
            head="Malignance Chapeau",
    body={ name="Lanun Frac +3", augments={'Mag. Acc.+2','"Dual Wield"+1',}},
    hands="Chasseur's Gants +1",
