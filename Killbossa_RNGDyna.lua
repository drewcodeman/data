...
function init_gear_sets()
    ...
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, {neck="Scout's Gorget +1"})
	...
	sets.precast.WS['Numbing Shot'] = set_combine(sets.precast.WS['Last Stand'], {ear2="Clearview Earring", waist="Thunder Belt",neck="Scout's Gorget +1"})
