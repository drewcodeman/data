    ...
    sets.midcast.Pet.BloodPactWard = 
{
    ...
    head="Apogee Crown +1",
    body="Con. Doublet +3",
     hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+9','Blood Pact Dmg.+8','Pet: "Mag.Atk.Bns."+11',}},
    ...
    head="Apogee Crown +1",
    body="Con. Doublet +3",
    hands={ name="Merlinic Dastanas", augments={'Pet: Mag. Acc.+23 Pet: "Mag.Atk.Bns."+23','Pet: AGI+6','Pet: "Mag.Atk.Bns."+15',}},
	legs="Apogee Slacks +1", 
    feet="Apogee Pumps +1",
    neck="Adad Amulet",
    waist="Caller's Sash",
